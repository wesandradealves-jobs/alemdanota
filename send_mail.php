...
if (isset($_POST['send_email']) && !empty($_POST['user_email']) && !empty($_POST['user_nome']) && !empty($_POST['user_msg'])) {
	...
	if (filter_var($_POST['user_email'], FILTER_VALIDATE_EMAIL)) {
		...
		$msg = $_POST['user_msg'];
		$email_servidor = "contato@alemdanota.com.br";
		$to = "contato@alemdanota.com.br";
		...
		<body style='background:#F2F2F2; max-width:600px; margin:auto; font-family:'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', 'Helvetica', 'Arial', sans-serif; '>	
		    ...
		    <div class='logo'><img src='https://www.alemdanota.com.br/logo_email_contato.png' style='width:150px'></div>
				<div class='header'>
